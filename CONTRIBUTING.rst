Contribute to pyproject-validator
=================================

Thank you for taking time to contribute to pyptoject-validator!

The following is a set of guidelines for contributing to pyptoject-validator. These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
...
#. Coding style is being handled by ruff and in genral by pre-commit
